...
public class DriveControl {
    public DriveControl() {
        ...
        gamepad1.getGamepadButton(BACK).and(gamepad1.getGamepadButton(DPAD_DOWN))
                .whenActive(drive.setPowerLow());

        gamepad1.getGamepadButton(BACK).and(gamepad1.getGamepadButton(DPAD_LEFT))
                .or(gamepad1.getGamepadButton(BACK)).and(gamepad1.getGamepadButton(DPAD_RIGHT))
                .whenActive(drive.setPowerMedium());

        gamepad1.getGamepadButton(BACK).and(gamepad1.getGamepadButton(DPAD_UP))
